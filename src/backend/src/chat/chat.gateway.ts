	...
	implements OnGatewayConnection, OnGatewayDisconnect, OnGatewayInit
{
	...
	const user1 = new User(2000,'hanmool')
	const user2 = new User(2001,'seunchoi')
	const user3 = new User(2002,'ysungwon')
	const user4 = new User(2003,'jaeyjeon')
	const user5 = new User(2004,'namkim')
	const user6 = new User(2005,'Progame')
	this.storeUser.saveUser(2000, user1)
	this.storeUser.saveUser(2001, user2)
	this.storeUser.saveUser(2002, user3)
	this.storeUser.saveUser(2003, user4)
	this.storeUser.saveUser(2004, user5)
	this.storeUser.saveUser(2005, user6)
